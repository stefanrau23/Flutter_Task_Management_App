// ignore_for_file: must_be_immutable, use_super_parameters, deprecated_member_use, prefer_const_constructors, override_on_non_overriding_member, unused_import
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text("Stefan Rahlitchi", style: textTheme.headline2),
          Text("Junior Java Developer", style: textTheme.headline3),
          Container(
